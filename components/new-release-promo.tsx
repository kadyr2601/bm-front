    ...
    return (
        <section className="py-8 container mx-auto px-4">
            <div className="mx-auto max-w-6xl">
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 md:p-10 shadow-2xl border border-white/10">
                    <div
                        className="absolute inset-0 opacity-30"
                        style={{
                            background:
                                "radial-gradient(circle at 20% 50%, rgba(147, 197, 253, 0.15), transparent 50%), radial-gradient(circle at 80% 50%, rgba(196, 181, 253, 0.15), transparent 50%)",
                        }}
                    />
                ...
                Thrive in Dubai.
                        ...
                        <p className="text-base md:text-lg text-white/60 mb-6 max-w-xl mx-auto text-pretty">
                            Your gateway to Dubai's luxury real estate market. Experience world-class properties and investment
                            opportunities.
                        </p>
                        ...
                        <div className="mb-6 flex justify-center">
                            <svg
                                ...
                                className="fill-white/90 opacity-80"
                            >
                        ...
                        <a
                            href="https://wa.me/971528667010?text=Hi%2C%20I%27m%20interested%20in%20booking%20a%20consultation%20for%20Dubai%20real%20estate"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-block group"
                        >
                            <div className="relative inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white text-slate-900 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20">
                                <Building2 className="w-5 h-5" />
                                <span>Book Consultation</span>
                                <div className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-900 text-white transition-transform duration-300 group-hover:translate-x-1">
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10">
                            <p className="text-sm font-medium text-white/40 tracking-[0.2em] uppercase">Brad M. Real Estate</p>
                        </div>
                    </div>
                </div>
            </div>
